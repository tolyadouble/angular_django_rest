...
describe('testMainController', function() {
  ...
  it('injectScope', inject(function() {
    var $scope = {};
...
describe('testIndexController', function() {
  ...
  it('testHttpRequest', inject(function() {
    var $scope = {};
...
describe('testProfileController', function() {
  ...
  it('testPatchProfileRequestOk', inject(function() {
    var $scope = {};
    $controller('ProfileController', {
      $scope: $scope
    });
  ...
  it('testPatchProfileRequestFail', inject(function() {
    var $scope = {};
    $controller('ProfileController', {
      $scope: $scope
    });
...
describe('testAddPostController', function() {
  ...
  it('testPostAddPostOk', inject(function() {
    var $scope = {};
  ...
  it('testPostAddPostFail', inject(function() {
    var $scope = {};
    $controller('AddPostController', {
      $scope: $scope
    });
...
describe('testLoginController', function() {
  ...
  it('testHttpRequestFail', inject(function() {
    var $scope = {};
    $controller('LoginController', {
      $scope: $scope
    });
...
describe('testSignupController', function() {
  ...
  it('testHttpRequestOk', inject(function() {
    var $scope = {};
